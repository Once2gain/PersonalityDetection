...
@dataclass
class SpecialLRScheduleConfig(FairseqDataclass):
...
@register_lr_scheduler("special", dataclass=SpecialLRScheduleConfig)
class SpecialLRSchedule(FairseqLRScheduler):
    """Decay the LR on a fixed schedule."""

    def __init__(self, cfg: SpecialLRScheduleConfig, optimizer):
