...
class RobertaModel(FairseqEncoderModel):
    ...
    def upgrade_state_dict_named(self, state_dict, name):
        ...
        # # Copy decoder into the state dict with their current weights.
        ...
        #
        # # rename layernorm_embedding -> emb_layer_norm
        # for k in list(state_dict.keys()):
...
class RobertaEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary):
        ...
        for layer in range(args.n_trans_layers_to_freeze):
            freeze_module_params(self.sentence_encoder.layers[layer])
            logger.info("freeze layer=" + str(layer))
